    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('operations.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="N_declaration" name="N_declaration" required>
            </div>

            <div class="form-group">
                <label for="La_Date">La Date:</label>
                <input type="date" class="form-control" id="La_Date" name="La_Date" required>
            </div>

            <div class="form-group">
                <label for="N_Facture">N Facture:</label>
                <input type="text" class="form-control" id="N_Facture" name="N_Facture" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="N_Bill" name="N_Bill" required>
            </div>

            <div class="form-group">
                <label for="N_Repartoire">N Repartoire:</label>
                <input type="text" class="form-control" id="N_Repartoire" name="N_Repartoire" required>
            </div>

            <div class="form-group">
                <label for="telecharger_fisher">Télécharger Fisher:</label>
                <input type="file" class="form-control-file" id="telecharger_fisher" name="telecharger_fisher" required>
            </div>
